var deviceInfo = function(){      
	...
	{
		new Ajax.Request('http://campusdev.diplomacy.edu/wiki/server/wikiList.asp?cmd=getwikis',
		  {
		    method:'get',
	...
	function goToLoginPage()
	{
		...
		//window.open('http://campusdev.diplomacy.edu/wiki/server/userLogin.asp?uname='+username+'&upwd='+password, 'log', 'width=100, height=200, resizable=no');
		
		//new Ajax.Request('http://campusdev.diplomacy.edu/wiki/server/userLogin.asp?uname=banek&upwd=04uspesan',
		new Ajax.Request('http://campusdev.diplomacy.edu/wiki/server/userLogin.asp?uname='+username+'&upwd='+password,
		  {
		    method:'get',
		    onSuccess: function(transport){
		      var response = transport.responseText || "no response text";
		      ...
		      try
			  {
		    	  var lmsUser = eval(newResponse); // this should be an array
		    	  if(lmsUser.status == "0")
		    	  {
		    		  navigator.notification.alert(
		    				  "Welcome "+lmsUser.fullname+"!",
		    				  goToWikiList,
		    				  "Login info",
		    				  "Continue");
	...
	function goToWikiList() {
		window.location = "wikilist.html";
	}
